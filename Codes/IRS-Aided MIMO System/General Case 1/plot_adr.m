...
plot(snr,ADR_propos_c4,'-d','color', [0.6 0.25  1 ], "linewidth", 3, "markersize", 8, "DisplayName", txt);
hold on

txt = ['No IRS, L = ' num2str(sys_par_c1(4))];
plot(snr,ADR_no_IRS_c1,'--s','color', [0.8 0.1  1 ], "linewidth", 3, "markersize", 10, "DisplayName", txt);
hold on

txt = ['No IRS, L = ' num2str(sys_par_c2(4))];
plot(snr,ADR_no_IRS_c2,'--+','color', [0.75 0.25  0 ], "linewidth", 3, "markersize", 10, "DisplayName", txt);
hold on

txt = ['No IRS, L = ' num2str(sys_par_c3(4))];
plot(snr,ADR_no_IRS_c3,'--x','color', [0.15 1  0.45 ], "linewidth", 3, "markersize", 10, "DisplayName", txt);
hold on

txt = ['No IRS, L = ' num2str(sys_par_c4(4))];
plot(snr,ADR_no_IRS_c4,'--d','color', [0.6 0.25  1 ], "linewidth", 3, "markersize", 8, "DisplayName", txt);
hold off

title(['Interference Treatment Model N = ' num2str(N), ', M_R = ' num2str(Mr), ', M_T = ' num2str(Mt)])
xlabel('SNR in dB')
