...
txt = ['No IRS'];
plot(snr,ADR_no_IRS_c1,'--x','color', [0.75 0.25  0 ], "linewidth", 3, "markersize", 10, "DisplayName", txt);
hold off

title(['Interference Treatment Model P = ' num2str(P), ', M_R = ' num2str(Mr), ', M_T = ' num2str(Mt)])
xlabel('SNR in dB')
